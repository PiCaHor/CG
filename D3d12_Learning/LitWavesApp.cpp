...
void LitWavesApp::UpdateMaterialCBs(const GameTimer& gy)
{
...
{
	mShaders["standardVS"] = d3dUtil::CompileShader(L"Shader\\wavelit.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"Shader\\wavelit.hlsl", nullptr, "PS", "ps_5_0");
